...
class SettingsMenu(Menu):
    ...
    def draw(self):
        ...
        for i, (setting_name, key_path, options) in enumerate(self.settings):
            ...
            # Row background
            row_rect = pygame.Rect(panel_x + 20, y - 20, panel_width - 40, 40)
            if is_selected:
            ...
            # Left/Right buttons
            btn_size = 30
            left_rect = pygame.Rect(panel_x + panel_width - 150, y - 15, btn_size, btn_size)
            right_rect = pygame.Rect(panel_x + panel_width - 50, y - 15, btn_size, btn_size)
            ...
            if isinstance(current_value, tuple):  # Color
                color_rect = pygame.Rect(panel_x + panel_width - 110, y - 10, 20, 20)
                pygame.draw.rect(self.screen, current_value, color_rect)
                pygame.draw.rect(self.screen, (255, 255, 255), color_rect, 1)
            else:  # FPS
                self.draw_text(str(current_value), self.font_medium, color, panel_x + panel_width - 100, y)
        ...
        self.draw_text("Arrow keys or click < > to adjust | ESC to go back",
                      ...
                      self.screen_width // 2, panel_y + panel_height + 30)
